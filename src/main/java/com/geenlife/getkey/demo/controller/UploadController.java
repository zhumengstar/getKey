...
public class UploadController {
    ...
    public String upload(@RequestParam("file") MultipartFile file) {
        ...
        try {
            ...
            HandlerFile.xmlToDocument(new Vector(),dest.getAbsolutePath());
    ...
    public String uploadFolder(MultipartFile[] folder) throws IOException {
        FileUtil.saveMultiFile("/Users/zgh/Desktop/java/getkey/src/main/resources/static/originfile", folder);
        return "上传成功";
    }
